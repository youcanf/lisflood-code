...
# class TestDrinaColdDayBase(TestLis):
...
class TestDrinaWarmDay(TestLis):
    settings_path = os.path.join(current_dir, 'data/Drina/settings/lisfloodSettings_warm_day.xml')
